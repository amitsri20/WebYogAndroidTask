...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadItems() {
        ...
        Call<List<Email>> call = apiService.loadItems();
        call.enqueue(new Callback<List<Email>>() {
            ...
            public void onResponse(Call<List<Email>> call, Response<List<Email>> response) {
                try {
                    ...
                    List<Email> emailData = response.body();
                    adapter = new WebyogAdapter(emailData, R.layout.list_item_layout, getApplicationContext());
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            private void init() {
                ...
                xMark = ContextCompat.getDrawable(MainActivity.this, R.drawable.ic_delete_black_24dp);
            ...
            public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                WebyogAdapter testAdapter = (WebyogAdapter)recyclerView.getAdapter();
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                WebyogAdapter adapter = (WebyogAdapter)recyclerView.getAdapter();
